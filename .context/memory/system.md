...
- When flashcard pronunciation or transliteration controls can reveal answers, keep them on the Arabic-facing side only, and only show pronunciation when the current word has bundled audio or another audible fallback; treat browser speech as a fallback rather than the primary availability signal. <!-- source: story-003, story-015 -->
